        ...
        (function(p) {
            ...
            a.a = function() {
                ...
                var k = {
                    ...
                    f = v && function() {
                        for (var a = 3, b = v.createElement("div"), c = b.getElementsByTagName("i"); b.innerHTML = "<!--[if gt IE " + ++a + "]><i></i><![endif]-->", c[0];);
                        return 4 < a ? a : p
                    }();
                return {
            ...
            (function() {
                ...
                var g = v && "<!--test-->" === v.createComment("test").text,
            ...
            (function() {
                a.Sa = function() {
                    ...
                    this.addTemplate = function(a, b) {
                        v.write("<script type='text/html' id='" + a + "'>" + b + "</script>")
                    };
